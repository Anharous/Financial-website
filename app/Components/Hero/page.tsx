        ...
        <>
            <div className="slider">
                <div className="slides">
                    <div className="slide"><Image src="/hero-one.svg" alt="Image-one" width={1519} height={723} /></div>
                ...
                <div className="slides">
                    <Image src="/hero-two.svg" alt="Image-two" width={1519} height={723} />
                    <div className="hero-para">
                ...
                <div className="slides">
                    <Image src="/hero-three.svg" alt="Image-three" width={1519} height={723} />
                    <div className="hero-para">
                ...
                <div className="slides">
                    <Image src="/hero-four.svg" alt="Image-four" width={1519} height={723} />
                    <div className="hero-para">
                ...
                <div className="slides">
                    <Image src="/hero-five.svg" alt="Image-five" width={1519} height={723} />
                    <div className="hero-para">
                ...
                <div className="slides">
                    <Image src="/hero-six.svg" alt="Image-six" width={1519} height={723} />
                    <div className="hero-para">
                ...
                <div className="slides">
                    <Image src="/hero-seven.svg" alt="Image-seven" width={1519} height={723} />
                    <div className="hero-para">
                ...
                <div className="slides">
                    <Image src="/hero-eight.svg" alt="Image-eight" width={1519} height={723} />
                    <div className="hero-para">
                ...
                <div className="slides">
                    <Image src="/hero-nine.svg" alt="Image-nine" width={1519} height={723} />
                    <div className="hero-para">
                ...
                <div className="slides">
                    <Image src="/hero-ten.svg" alt="Image-ten" width={1519} height={723} />
                    <div className="hero-para">
